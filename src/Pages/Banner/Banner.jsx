        ...
        <div className='mt-14'>
            ...
            <div className='bg-[linear-gradient(125.07deg,rgba(99,46,227,1),rgba(159,98,242,1)_100%)] p-20'>
                <div className='max-w-[1280px] mx-auto'>
                    <h1 className='text-center text-white font-bold text-4xl lg:text-5xl mb-10'>
                        Trusted by Millions, Built for You</h1>
                    <div className='flex flex-col space-y-8 lg:flex-row lg:justify-between'>
                        <div className='text-white text-center'>
                            <p>Total Downloads</p>
                            <h1 className='font-extrabold text-4xl lg:text-6xl my-2 lg:my-4'>29.6M</h1>
                            <p>21% more than last month</p>
                        </div>
                        <div className='text-white text-center'>
                            <p>Total Reviews</p>
                            <h1 className='font-extrabold text-4xl lg:text-6xl my-2 lg:my-4'>906K</h1>
                            <p>46% more than last month</p>
                        </div>
                        <div className='text-white text-center'>
                            <p>Active Apps</p>
                            <h1 className='font-extrabold text-4xl lg:text-6xl my-2 lg:my-4'>132+</h1>
